...
def build_prompt_from_config(
    ...
    if input_data:
        # Convert input_data list to a string if it's not already
...
def build_system_prompt_from_config(
    ...
    Args:
        ...
        research_content: The research content to include in the system prompt.
    ...
    # Include research content if provided
    if research_content:
        prompt_parts.append(
            "Base your responses on this research content:\n\n"
            "=== RESEARCH CONTENT ===\n"
